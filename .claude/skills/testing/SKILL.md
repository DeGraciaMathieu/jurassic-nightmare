...
| `test/rex.test.js` | détection + rugissement, LOS coupée par un mur, herbe (quasi-invisible), détournement par flare, investigation hors de vue, capture → scare → dead |
